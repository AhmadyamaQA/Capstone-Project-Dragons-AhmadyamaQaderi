Feature: Retail Account
  ...
  Scenario: Verify User can update Profile Information
    And User update Name 'Alex' and phone '200-301-1011'
  ...
  Scenario: Verify User can add a payment method
    ...
    And User fill Debit or credit card information
      ...
      | 1223567613122333 | John        |              11 |           2026 |          270 |
    And User click on Add your card button
    Then a message should be displayed 'Payment Method added sucessfully'

  @EditPaymentMethod
  Scenario: Verify User can edit Debit or Credit card
    And User select the card ending with '2333'
    And User click on Edit option of card section
    And user edit information with below data
      | cardNumber       | nameOnCard | expirationMonth | expirationYear | securityCode |
      | 3312187994341111 | Bob        |              12 |           2024 |          801 |
  ...
  Scenario: Verify User can add an Address
    ...
    And user fill new address form with below information
      ...
      | United States | Ali     | 917-888-9991 | 101 Laguna Blvd |  11 | Elk Grove | California |   95916 |
